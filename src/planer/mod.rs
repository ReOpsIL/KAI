...
pub use plan::{Plan, Phase};
pub use queue::{ExecutionQueue, QueueRequest, QueueResponse};
pub use task_planner::TaskPlanner;
pub use task_executor::TaskExecutor;
pub use schemas::{TaskDecomposition, PlanResponse, SimpleTask, PlanPhase, create_json_prompt};
...
impl Planner {
    ...
    pub fn get_status(&self) -> String {
        format!(
            ...
            if self.task_executor.verbose { "Verbose" } else { "Quiet" }
        )
    }
}
...
mod tests {
    ...
    fn test_planner_creation() {
        ...
        assert_eq!(planner.task_planner.get_status(), "Active Plans: 0, Pending Requests: 0");
    }
